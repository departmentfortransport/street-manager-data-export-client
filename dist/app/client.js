...
class StreetManagerDataExportClient {
    ...
    generatePermitAlterationOutcomesCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/performance-reporting/permit-alteration-outcomes/csv', request, this.generateRequestConfig(config)));
        });
    }
    ...
    generateCommentsCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/comments/csv', request, this.generateRequestConfig(config)));
        });
    }
    generateInspectionOutcomesCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/performance-reporting/inspection-outcomes/csv', request, this.generateRequestConfig(config)));
        });
    }
    generatePermitsCreatedCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/performance-reporting/permits-created/csv', request, this.generateRequestConfig(config)));
        });
    }
    generateFPNsCreatedCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/performance-reporting/fpns-created/csv', request, this.generateRequestConfig(config)));
        });
    }
    generatePermitOutcomesCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/performance-reporting/permit-outcomes/csv', request, this.generateRequestConfig(config)));
        });
    }
    generatePermitAlterationsCreatedCSV(config, request) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.httpHandler(() => this.axios.post('/performance-reporting/permit-alterations-created/csv', request, this.generateRequestConfig(config)));
        });
    }
    getCSV(config, csvId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    generateStreamRequestConfig(config, request) {
        return Object.assign(Object.assign({}, this.generateRequestConfig(config, request)), { responseType: 'stream', transformResponse: data => data });
    }
    handleError(err) {
